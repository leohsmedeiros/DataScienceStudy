...
"""
OBJETIVO:
    testar uma nova base de dados, depois de o algoritmo ter sido treinado pela base de treinamento
"""
...
"""
NOVA BASE DE DADOS DE INPUT (A SER CLASSIFICADA)
"""
...
"""
IMPORTANTE:
    - É NECESSÁRIO QUE TODOS OS ATRIBUTOS ESTEJAM NA MESMA ORDEM E NO MESMO FORMATO
    QUE O CONJUNTO USADO DE TREINAMENTO (ou seja, vai ser obrigatório aplicar
    o LabelEncoder nesta nova base de dados também)
    - Neste caso, é importante reaproveitar o labelencoder, para garantir que os índices
    que foram colocados, nos lugares das variáveis qualitativas, sejam os mesmos
"""
